        ...
        $st = db()->prepare(
            'INSERT INTO user_names
             ...
             ON DUPLICATE KEY UPDATE
                ...
                is_engineer = VALUES(is_engineer)'
        );
...
<div class="shell">
    ...
    <main class="login">
        ...
        <form method="post" class="card">
            ...
            <p class="hint">
                Временный режим авторизации до подключения VATSIM OAuth 2.0.
            </p>
        </form>
    </main>
</div>
...
<div class="shell">
    ...
    <form method="post" class="card" id="edit">
        <h2>Добавить или исправить пользователя</h2>
        ...
        <label class="engineer-check">
            <input
                ...
                name="is_engineer"
                value="1"
                <?= !empty($form['is_engineer']) ? 'checked' : '' ?>
            >
        ...
        <div class="top">
            ...
            <div class="search">
                <input
                    id="filter"
                    type="search"
                    placeholder="Поиск по имени или CID"
                    aria-label="Поиск"
                >
            </div>
        </div>
                        ...
                        <td class="actions">
                            <div class="acts">
                                ...
                                <form
                                    method="post"
                                    class="js-confirm"
                                    data-question="Удалить <?= h($row['name']) ?>?"
                                >
    ...
    <script>
        document.querySelectorAll('.js-edit').forEach(function (button) {
            button.addEventListener('click', function () {
                document.getElementById('cid').value = button.dataset.cid;
